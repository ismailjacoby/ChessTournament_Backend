package be.technobel.chesstournament.pl.config.security;
...
public class JWTProvider {
    private static final String JWT_SECRET = "wddEjvgzedmMQWUbntnvmfqHG8FBn7NQfLN7BWgCtyLUGpk8Kw";
    ...
    public boolean validateToken(String token){
        ...
        try {
            ...
            Role tokenRole = Role.valueOf(jwt.getClaim("role").asString());
